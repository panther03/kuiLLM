module Kuiops.Kernel.GEMM.TensorCore2D.To
...
open Kuiops.Kernel.GEMM.TensorCore2D.To.KernelDesc.Teardown
open Kuiops.Kernel.GEMM.TensorCore2D.To.BaseSendable
open Kuiops.Kernel.GEMM.TensorCore2D.To.KernelBody
   ...
   warp_divides_thread_count bm bn tm tn wm wn nthr in
{
  ...
  f = kf comb comb_r
    gA #eA gB #eB gC #eC gD
    bm bn bk tm tn tk wm wn
    rA rB rC nblk nblk #() nthr #warp_divides;
