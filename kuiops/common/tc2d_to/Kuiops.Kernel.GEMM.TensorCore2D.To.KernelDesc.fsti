module Kuiops.Kernel.GEMM.TensorCore2D.To.KernelDesc
#lang-pulse
...
(* These arithmetic facts occur in tile-index refinements.  Explicit triggers
   keep them available when current F* splits the surrounding obligations. *)
...
let div_nonneg_pat (a : nat) (b : pos)
