module Kuiops.Kernel.GEMM.TensorCore2D.To.KernelBody
...
open Kuiops.Kernel.GEMM.TensorCore2D.To.Epilogue
open Kuiops.Kernel.GEMM.TensorCore2D.To.KLoop
open Kuiops.Kernel.GEMM.TensorCore2D.To.Finish
...
fn kf
  ...
  (nblk_grid : szp)
  (#_ : squash (SZ.v nblk_grid == SZ.v nblk))
  (nthr : szp {
