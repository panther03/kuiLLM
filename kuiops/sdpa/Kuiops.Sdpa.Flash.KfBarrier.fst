...
fn sdpa_flash_block_prologue
  ...
  requires
    ...
    B.barrier_tok (barrier_contract nw d shQ (SF.q_tile 16 (SZ.v rows) (SZ.v group) eQ (SZ.v bi) (SZ.v kvh) (SZ.v r0)) shM shL eM eL shscale shO shgl) **
    B.barrier_state 0 **
    (gQ |-> Frac fQ eQ) **
      ...
      cell_full_v (row shL (SZ.v (tid /^ 32sz))) (SZ.v (tid %^ 32sz)) zero)
{
  ...
  rewrite (b0_pre nw d shQ (SF.q_tile 16 (SZ.v rows) (SZ.v group) eQ (SZ.v bi) (SZ.v kvh) (SZ.v r0)) shO (SZ.v tid))
       as ((barrier_contract nw d shQ (SF.q_tile 16 (SZ.v rows) (SZ.v group) eQ (SZ.v bi) (SZ.v kvh) (SZ.v r0)) shM shL eM eL shscale shO shgl).rin 0 (SZ.v tid));
  B.barrier_wait ();
  rewrite ((barrier_contract nw d shQ (SF.q_tile 16 (SZ.v rows) (SZ.v group) eQ (SZ.v bi) (SZ.v kvh) (SZ.v r0)) shM shL eM eL shscale shO shgl).rout 0 (SZ.v tid))
...
fn sdpa_flash_block_barrier1
  ...
  requires
    gpu **
    thread_id (block_threads nw) tid **
    B.barrier_tok (barrier_contract nw d shQ eQsh shM shL eM eL shscale shO shgl) **
    B.barrier_state 1 **
    ...
    b1_post_v nw shM shL eM eL (SZ.v tid)
{
  rewrite (b1_pre_v nw shM shL eM eL (SZ.v tid))
       as ((barrier_contract nw d shQ eQsh shM shL eM eL shscale shO shgl).rin 1 (SZ.v tid));
  B.barrier_wait ();
  rewrite ((barrier_contract nw d shQ eQsh shM shL eM eL shscale shO shgl).rout 1 (SZ.v tid))
    ...
    b2_post nw d shscale shO shgl (SZ.v tid)
{
  rewrite (b2_pre nw d shscale shO shgl (SZ.v tid))
       as ((barrier_contract nw d shQ eQsh shM shL eM eL shscale shO shgl).rin 2 (SZ.v tid));
  B.barrier_wait ();
  rewrite ((barrier_contract nw d shQ eQsh shM shL eM eL shscale shO shgl).rout 2 (SZ.v tid))
      ...
      (cell_full shgm (SZ.v (clamp_lt 16sz lane)))
{
  split (combine_active 16sz w lane)
    (flash_scale_tile nw shscale (SZ.v (clamp_lt 16sz lane)))
    (cell_full shgl (SZ.v (clamp_lt 16sz lane)) **
     cell_full shgm (SZ.v (clamp_lt 16sz lane)));
  split (combine_active 16sz w lane)
    (cell_full shgl (SZ.v (clamp_lt 16sz lane)))
