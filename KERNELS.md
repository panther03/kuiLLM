...
| \[e2] aten.add.Tensor                                     | T(3,f32,c), float                                         | T(3,f32,c)                                                 |                                                     |  no        |
...
| \[e2] aten.mul.Tensor                                     | T(2,f32,c), float                                         | T(2,f32,c)                                                 |                                                     |  no        |
| \[e2] aten.mul.Tensor                                     | T(1,bf16,c), T(3,bf16,c)                                  | T(3,bf16,c)                                                |                                                     |  no        |
| \[e2] aten.mul.Tensor                                     | T(1,int64,c), T(1,int64,c)                                | T(1,int64,c)                                               |                                                     |  yes       |
| \[e2] aten.mul.Tensor                                     | T(3,f32,c), float                                         | T(3,f32,c)                                                 |                                                     |  no        |
| \[e2] aten.mul.Tensor                                     | T(3,f32,c), T(3,f32,c)                                    | T(3,f32,c)                                                 |                                                     |  no?? (#27)|
...
| \[e1] aten.pow\.Tensor\_Scalar                            | T(3,f32,c), int                                           | T(3,f32,c)                                                 |                                                     | yes (#29)  |
...
| aten.addmm.default                                        | T(1,bf16,c), T(2,bf16,c), T(2,bf16,c)                     | T(2,bf16,c)                                                |                                                     | yes (#4)   |
