...
def _build_registry(tune_params):
    ...
    return {
        ...
        aten.sub.Tensor: _ELEM,
        aten.sub.Scalar: _ELEM,
        aten.div.Tensor: _ELEM,
        aten.div.Scalar: _ELEM,
        aten.bitwise_not.default: _ELEM,
        aten.bitwise_and.Tensor: _ELEM,
        aten.bitwise_or.Tensor: _ELEM,
        aten.eq.Scalar: _ELEM,
        aten.le.Scalar: _ELEM,
        aten.lt.Scalar: _ELEM,
        aten.where.self: _ELEM,
        aten.mm.default: _MM,
